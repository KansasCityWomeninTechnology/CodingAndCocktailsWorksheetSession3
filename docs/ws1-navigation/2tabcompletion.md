1. Type in `cd Cod` then press `Tab` <i class="fa fa-share fa-rotate-180"></i>. Tab completion will find your "CodingAndCocktails" folder and fill in the rest of the directory name for you!
